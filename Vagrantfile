...
CONFIG_K0SCTL_VERSION = 'v0.13.1' # see https://github.com/k0sproject/k0sctl/releases
CONFIG_K0S_VERSION = 'v1.23.8+k0s.0' # see https://github.com/k0sproject/k0s/releases
CONFIG_KUBECTL_VERSION = CONFIG_K0S_VERSION.gsub(/v([\.\d]+).+/, '\1')
CONFIG_K9S_VERSION = 'v0.25.21' # see https://github.com/derailed/k9s/releases
...
CONFIG_HELM_VERSION = 'v3.9.0' # see https://github.com/helm/helm/releases BUT make sure you use a version compatible with k0s go.mod.
