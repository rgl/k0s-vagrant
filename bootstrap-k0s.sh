...
# see https://docs.k0sproject.io/v1.26.2+k0s.1/k0sctl-install/
# see https://docs.k0sproject.io/v1.26.2+k0s.1/configuration/
python3 <<'EOF'
import json
                        ...
                        'extensions': {
                            'helm': {
                                ...
                                'charts': [
                                    ...
                                    # see https://docs.k0sproject.io/v1.26.2+k0s.1/examples/traefik-ingress/
                                    {
                                        'name': 'traefik',
...
# see https://docs.k0sproject.io/v1.26.2+k0s.1/FAQ/#why-doesnt-kubectl-get-nodes-list-the-k0s-controllers
