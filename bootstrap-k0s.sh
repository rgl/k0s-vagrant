...
# see https://docs.k0sproject.io/v1.24.3+k0s.0/k0sctl-install/
# see https://docs.k0sproject.io/v1.24.3+k0s.0/configuration/
python3 <<'EOF'
import json
                        ...
                        'extensions': {
                            'helm': {
                                ...
                                'charts': [
                                    ...
                                    # see https://docs.k0sproject.io/v1.24.3+k0s.0/examples/traefik-ingress/
                                    {
                                        'name': 'traefik',
                                        'chartname': 'traefik/traefik',
                                        'version': '10.24.2', # installs traefik 2.8.4.
                                    ...
                                    # see https://github.com/bitnami/charts/tree/master/bitnami/metallb
                                    {
                                        ...
                                        'version': '4.1.2', # installs metallb 0.13.5.
                                    ...
                                    # see https://github.com/kubernetes-sigs/external-dns/blob/master/docs/initial-design.md
                                    {
                                        ...
                                        'version': '6.7.5', # installs external-dns 0.12.2.
                                    ...
                                    # see https://github.com/kubernetes/dashboard/blob/master/aio/deploy/helm-chart/kubernetes-dashboard/values.yaml
                                    {
                                        ...
                                        'version': '5.8.0', # installs kubernetes-dashboard 2.6.1.
...
# see https://docs.k0sproject.io/v1.24.3+k0s.0/FAQ/#why-doesnt-kubectl-get-nodes-list-the-k0s-controllers
