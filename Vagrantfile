...
CONFIG_DOCKER_VERSION = '23.0.1' # NB execute apt-cache madison docker-ce to known the available versions.
CONFIG_K0SCTL_VERSION = 'v0.15.0' # see https://github.com/k0sproject/k0sctl/releases
CONFIG_K0S_VERSION = 'v1.26.0+k0s.0' # see https://github.com/k0sproject/k0s/releases
CONFIG_KUBECTL_VERSION = CONFIG_K0S_VERSION.gsub(/v([\.\d]+).+/, '\1')
CONFIG_K9S_VERSION = 'v0.27.2' # see https://github.com/derailed/k9s/releases
...
CONFIG_HELM_VERSION = 'v3.10.3' # see https://github.com/helm/helm/releases BUT make sure you use a version compatible with k0s go.mod.
CONFIG_HELMFILE_VERSION = '0.149.0' # see https://github.com/helmfile/helmfile/releases
