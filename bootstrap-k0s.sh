...
# see https://docs.k0sproject.io/v1.25.5+k0s.0/k0sctl-install/
# see https://docs.k0sproject.io/v1.25.5+k0s.0/configuration/
python3 <<'EOF'
import json
                        ...
                        'extensions': {
                            'helm': {
                                ...
                                'charts': [
                                    ...
                                    # see https://docs.k0sproject.io/v1.25.5+k0s.0/examples/traefik-ingress/
                                    {
                                        'name': 'traefik',
                                        'chartname': 'traefik/traefik',
                                        'version': '20.8.0', # installs traefik 2.9.6.
                                    ...
                                    # see https://github.com/kubernetes-sigs/external-dns/blob/master/docs/initial-design.md
                                    {
                                        ...
                                        'version': '6.12.0', # installs external-dns 0.13.1.
...
# see https://docs.k0sproject.io/v1.25.5+k0s.0/FAQ/#why-doesnt-kubectl-get-nodes-list-the-k0s-controllers
