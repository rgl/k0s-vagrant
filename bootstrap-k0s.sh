...
# see https://docs.k0sproject.io/v1.26.5+k0s.0/k0sctl-install/
# see https://docs.k0sproject.io/v1.26.5+k0s.0/configuration/
python3 <<'EOF'
import json
                        ...
                        'extensions': {
                            'helm': {
                                ...
                                'charts': [
                                    ...
                                    # see https://docs.k0sproject.io/v1.26.5+k0s.0/examples/traefik-ingress/
                                    {
                                        'name': 'traefik',
                                    ...
                                    # see https://github.com/bitnami/charts/tree/master/bitnami/metallb
                                    {
                                        ...
                                        'version': '4.1.20', # installs metallb 0.13.9.
                                    ...
                                    # see https://github.com/kubernetes-sigs/external-dns/blob/master/docs/initial-design.md
                                    {
                                        ...
                                        'version': '6.14.3', # installs external-dns 0.13.3.
...
# see https://docs.k0sproject.io/v1.26.5+k0s.0/FAQ/#why-doesnt-kubectl-get-nodes-list-the-k0s-controllers
