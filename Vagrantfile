...
CONFIG_K0S_VERSION = 'v1.26.2+k0s.1' # see https://github.com/k0sproject/k0s/releases
...
CONFIG_HELMFILE_VERSION = '0.154.0' # see https://github.com/helmfile/helmfile/releases
