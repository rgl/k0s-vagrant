...
CONFIG_K0S_VERSION = 'v1.26.1+k0s.0' # see https://github.com/k0sproject/k0s/releases
...
CONFIG_HELM_VERSION = 'v3.11.1' # see https://github.com/helm/helm/releases BUT make sure you use a version compatible with k0s go.mod.
