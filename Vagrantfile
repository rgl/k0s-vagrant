...
CONFIG_DOCKER_VERSION = '20.10.19' # NB execute apt-cache madison docker-ce to known the available versions.
CONFIG_K0SCTL_VERSION = 'v0.14.0' # see https://github.com/k0sproject/k0sctl/releases
CONFIG_K0S_VERSION = 'v1.24.6+k0s.0' # see https://github.com/k0sproject/k0s/releases
