...
# see https://docs.k0sproject.io/v1.26.1+k0s.0/k0sctl-install/
# see https://docs.k0sproject.io/v1.26.1+k0s.0/configuration/
python3 <<'EOF'
import json
                        ...
                        'extensions': {
                            'helm': {
                                ...
                                'charts': [
                                    ...
                                    # see https://docs.k0sproject.io/v1.26.1+k0s.0/examples/traefik-ingress/
                                    {
                                        'name': 'traefik',
                                        'chartname': 'traefik/traefik',
                                        'version': '21.0.0', # installs traefik 2.9.6.
                                    ...
                                    # see https://github.com/bitnami/charts/tree/master/bitnami/metallb
                                    {
                                        ...
                                        'version': '4.1.14', # installs metallb 0.13.7.
                                    ...
                                    # see https://github.com/kubernetes-sigs/external-dns/blob/master/docs/initial-design.md
                                    {
                                        ...
                                        'version': '6.13.2', # installs external-dns 0.13.2.
                                    ...
                                    # see https://github.com/kubernetes/dashboard/blob/master/aio/deploy/helm-chart/kubernetes-dashboard/values.yaml
                                    {
                                        ...
                                        'version': '6.0.0', # installs kubernetes-dashboard 2.7.0.
...
# see https://docs.k0sproject.io/v1.26.1+k0s.0/FAQ/#why-doesnt-kubectl-get-nodes-list-the-k0s-controllers
