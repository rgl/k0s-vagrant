...
# see https://docs.k0sproject.io/v1.26.0+k0s.0/k0sctl-install/
# see https://docs.k0sproject.io/v1.26.0+k0s.0/configuration/
python3 <<'EOF'
import json
                        ...
                        'extensions': {
                            'helm': {
                                ...
                                'charts': [
                                    ...
                                    # see https://docs.k0sproject.io/v1.26.0+k0s.0/examples/traefik-ingress/
                                    {
                                        'name': 'traefik',
...
# see https://docs.k0sproject.io/v1.26.0+k0s.0/FAQ/#why-doesnt-kubectl-get-nodes-list-the-k0s-controllers
