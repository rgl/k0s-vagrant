...
CONFIG_DOCKER_VERSION = '20.10.16' # NB execute apt-cache madison docker-ce to known the available versions.
CONFIG_K0SCTL_VERSION = 'v0.12.6' # see https://github.com/k0sproject/k0sctl/releases
CONFIG_K0S_VERSION = 'v1.23.6+k0s.2' # see https://github.com/k0sproject/k0s/releases
...
CONFIG_ETCDCTL_VERSION = 'v3.5.4' # see https://github.com/etcd-io/etcd/releases BUT make sure you use the same version as k0s.
CONFIG_HELM_VERSION = 'v3.9.0' # see https://github.com/helm/helm/releases BUT make sure you use the same version as k0s.
